import { _ as _export_sfc, a as useI18n, r as reactive, j as onMounted, b as createElementBlock, o as openBlock, h as createBaseVNode, e as createCommentVNode, c as createBlock, g as createVNode, u as unref, k as Field, Q as Filters, S as _sfc_main$b, F as Fragment, d as renderList, n as normalizeClass, ae as ArtistPreview, D as Button, E as EmptyLabel, i as api, A as computed, t as toDisplayString, m as watch, af as knownSites, I as IconButton, ag as isValidURL, ah as detectSiteCode, s as stores, ai as isInvalidEmail, w as withDirectives, v as vShow, aj as maskArtistCode, K as Teleport, M as Loader, N as delay, G as message, O as withCtx, H as Img, Y as AutoComplete, ak as TRACK_CONTRIBUTOR_ROLES, W as TrackPreview, al as LoadMore, a3 as RELEASE_CONTRIBUTOR_ROLES, a4 as ReleasePreview, f as ref, q as resolveComponent, a2 as createSlots, V as _sfc_main$e, am as ARTISTS_FILTERS, an as ARTISTS_SORT, T as Tracks, R as Releases } from './index-DPT6fUi9.js';
import { P as PageHeader } from './PageHeader-D3aCCL9x.js';
import { d as _sfc_main$c, f as IconState, e as _sfc_main$d, P as PageHeaderArtistTitle, T as TrackEditor } from './TrackEditor-CTa1-NV7.js';
import { T as Total, M as Menu } from './Menu-DjyfHmlf.js';
import { F as FileUploader, T as Textarea } from './FileUploader-lpPEvCeS.js';
import { L as LicenseTrackEditor } from './LicenseTrackEditor-CeqG5unT.js';
import { R as ReleaseEditor } from './ReleaseEditor-DYE4LYb6.js';
import './ViewMode-C5SdHbln.js';

const _hoisted_1$a = { class: "items-list" };
const _hoisted_2$9 = { class: "filters" };
const _hoisted_3$6 = {
  key: 0,
  class: "items"
};
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const getItems = async () => {
        ...
        if (props.endpoint === 'all') {
            payload = await api.artists().list(params, 'pages') || [];
...
const Artists$1 = /*#__PURE__*/_export_sfc(_sfc_main$a, [['__scopeId',"data-v-a7dd98b4"]]);

const _hoisted_1$9 = { class: "artist-menu" };
const _hoisted_2$8 = { class: "items" };
...
const _sfc_main$9 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    // Permissions
        ...
        const canEditCuratorSettings = computed(() => {
            if (!props.item?.id) {
                return false;
            }

            return api.artists().canEditCuratorSettings({
                artist: props.item
            })
        });
    ...
    const items = computed(() => ([
        {
            ...
            name: 'pages.artists.menu.settings',
            code: 'settings',
            disabled: !props.item?.id || !canEditCuratorSettings.value
        }
...
const ArtistMenu = /*#__PURE__*/_export_sfc(_sfc_main$9, [['__scopeId',"data-v-cb08662f"]]);

const _hoisted_1$8 = { class: "links-field" };
...
const LinksField = /*#__PURE__*/_export_sfc(_sfc_main$8, [['__scopeId',"data-v-b41b3346"]]);
...
const _hoisted_3$4 = { class: "form-line" };
const _hoisted_4$3 = { class: "form-line" };
const _hoisted_5$3 = { class: "box" };
const _hoisted_6$3 = { class: "attention" };
  ...
  setup(__props, { emit: __emit }) {
    ...
    const onCodeChange = (e) => {
        if (data.code !== e.target.value?.trim()) {
            data.code = e.target.value?.trim()?.toLowerCase();
            onEdit();
        }
    };
  ...
  return (openBlock(), createElementBlock(Fragment, null, [
    (!data.loading)
      ? withDirectives((openBlock(), createElementBlock("div", _hoisted_1$7, [
          createBaseVNode("label", _hoisted_2$7, toDisplayString(unref(t)(`pages.artists.${ props.item?.id ? 'edit' : 'add' }.title`)), 1),
...
const ArtistInfo = /*#__PURE__*/_export_sfc(_sfc_main$7, [['__scopeId',"data-v-884a1cf1"]]);
...
const _hoisted_5$2 = { class: "form-line" };
const _hoisted_6$2 = { class: "form-line" };
  ...
  return (openBlock(), createElementBlock(Fragment, null, [
    (!data.loading)
      ? withDirectives((openBlock(), createElementBlock("div", _hoisted_1$6, [
          createBaseVNode("label", _hoisted_2$6, toDisplayString(unref(t)(`pages.artists.dict.title`)), 1),
...
const ArtistMetadata = /*#__PURE__*/_export_sfc(_sfc_main$6, [['__scopeId',"data-v-01618d08"]]);
...
const _hoisted_4$1 = { class: "user-option-preview" };
const _hoisted_5$1 = { class: "name" };
const _hoisted_6$1 = { class: "username" };
  ...
  return (openBlock(), createElementBlock(Fragment, null, [
    (!data.loading)
      ? withDirectives((openBlock(), createElementBlock("div", _hoisted_1$5, [
          createBaseVNode("label", _hoisted_2$5, toDisplayString(unref(t)(`pages.artists.team.title`)), 1),
            ...
            createVNode(AutoComplete, {
              ...
              option: withCtx(({ option }) => [
                createBaseVNode("span", _hoisted_4$1, [
                  (option.profileImage?.resized || defaultUserImage.value.resized)
                    ? (openBlock(), createBlock(Img, {
                        key: 0,
                        preview: option.profileImage?.resized || defaultUserImage.value.resized,
                        original: option.profileImage?.original || defaultUserImage.value.original,
                        alt: option?.name
                      }, null, 8, ["preview", "original", "alt"]))
                    : createCommentVNode("", true),
                  createBaseVNode("span", _hoisted_5$1, toDisplayString(option.name), 1),
                  createBaseVNode("span", _hoisted_6$1, "@" + toDisplayString(option.userName), 1)
                ])
              ]),
              value: withCtx(({ value }) => [
                createBaseVNode("span", _hoisted_7, [
                  (value.profileImage?.resized || defaultUserImage.value.resized)
                    ? (openBlock(), createBlock(Img, {
                        key: 0,
                        preview: value.profileImage?.resized || defaultUserImage.value.resized,
                        original: value.profileImage?.original || defaultUserImage.value.original,
                        alt: value?.name
                      }, null, 8, ["preview", "original", "alt"]))
                    : createCommentVNode("", true),
...
const ArtistTeam = /*#__PURE__*/_export_sfc(_sfc_main$5, [['__scopeId',"data-v-7c7be1ac"]]);

const _hoisted_1$4 = { class: "collab-invites-list" };
const _hoisted_2$4 = { class: "role" };
...
const CollabInvitesTracks = /*#__PURE__*/_export_sfc(_sfc_main$4, [['__scopeId',"data-v-755d16a8"]]);
...
const CollabInvitesReleases = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-df89557e"]]);
...
return (_ctx, _cache) => {
  return (!data.loading)
    ? withDirectives((openBlock(), createElementBlock("div", _hoisted_1$2, [
        createBaseVNode("label", _hoisted_2$2, toDisplayString(unref(t)(`pages.artists.collab-invites.title`)), 1),
...
const ArtistCollabInvites = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-ae03c488"]]);

const _hoisted_1$1 = {
  key: 0,
  class: "artist-settings"
};
const _hoisted_2$1 = { class: "title" };
const _hoisted_3 = { class: "form-line" };
const _hoisted_4 = { class: "box" };
const _hoisted_5 = { class: "attention" };
const _hoisted_6 = {
  key: 1,
  class: "loader"
};
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const data = reactive({
        id: null,
        MAX_TRACK_CREATE_COUNT: null,
        loading: true
    });

    const saveDisabled = computed(() => {
        return !data.id || !data.MAX_TRACK_CREATE_COUNT || !data.hasChanges;
    });
    ...
    const onMaxTrackCountChange = (e) => {
        if (!!+e.target.value) {
            data.MAX_TRACK_CREATE_COUNT = +e.target.value;
            onEdit();
        } else {
            data.MAX_TRACK_CREATE_COUNT = null;
            onEdit();
        }
    };
    ...
    const saveChanges = async () => {
        ...
        if (data.id) {
            await entity.artist.curator(
                props.item.id,
                'MAX_TRACK_CREATE_COUNT',
                data.MAX_TRACK_CREATE_COUNT
            );
        }
    ...
    const getItem = async () => {
        data.loading = true;
        const curatorSettings = await entity.artist.curator(props.item.id);

        // Максимальное количество треков
        data.MAX_TRACK_CREATE_COUNT = curatorSettings?.MAX_TRACK_CREATE_COUNT;
  ...
  return (openBlock(), createElementBlock(Fragment, null, [
    (!data.loading)
      ? withDirectives((openBlock(), createElementBlock("div", _hoisted_1$1, [
          createBaseVNode("label", _hoisted_2$1, toDisplayString(unref(t)(`pages.artists.settings.title`)), 1),
          createBaseVNode("div", _hoisted_3, [
            createBaseVNode("label", null, toDisplayString(unref(t)('pages.artists.settings.max-track-count.title')), 1),
            createBaseVNode("div", _hoisted_4, [
              createVNode(Field, {
                placeholder: unref(t)(`pages.artists.settings.max-track-count.title`),
                value: data.MAX_TRACK_CREATE_COUNT,
                disabled: !canEditCuratorSettings.value,
                type: "number",
                min: 1,
                class: "noerror light with-placeholder",
                onChange: onMaxTrackCountChange
              }, null, 8, ["placeholder", "value", "disabled"]),
              createBaseVNode("span", _hoisted_5, [
                createBaseVNode("span", null, toDisplayString(unref(t)(`pages.artists.settings.max-track-count.description`)), 1)
              ])
            ])
          ]),
          (openBlock(), createBlock(Teleport, { to: "#item-head-buttons" }, [
            createVNode(Button, {
              name: unref(t)(`pages.artists.edit.save`),
              class: "size-s secondary",
              disabled: saveDisabled.value || !canEditCuratorSettings.value,
              onClick: saveChanges
            }, null, 8, ["name", "disabled"])
          ]))
        ], 512)), [
...
const ArtistSettings = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-651756ab"]]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    // Tracks
        ...
        const checkTracksLimit = async (count) => {
            let params = {
                skip: 0,
                take: 1
            };
            ...
            if (data.item) {
                params.contributors = [data.item?.id].join(',');
            }

            const payload = await api.tracks().list(params) || [];
            const maxCount = await api.entity().artist.curator(data.item?.id, 'MAX_TRACK_CREATE_COUNT');

            if (!maxCount) {
                return false;
            }

            const availableCount = maxCount - (payload?.total || 0);
            if (availableCount < count) {
                modals.open('reject', {
                    data: {
                        ...
                        description: `${
                            availableCount > 0 ? t(`pages.tracks.limit.available`, { n: availableCount }) : ''
                        } ${
        ...
        const addTracks = async (count) => {
            if (!await checkTracksLimit(count)) {
                return;
            }
            data.editorTracks = [];
        ...
        const closeTrackEditorMode = () => {
            ...
            const onUpdateTrack = (track) => {
                ...
                if (track?.id) {
                    const index = data.editorTracks.findIndex(item => item.id === track.id);
                    if (index !== -1) {
                        data.editorTracks.splice(index, 1, track);
                    }
                }
            };
    ...
    // Releases
        ...
        const closeReleaseEditorMode = () => {
            ...
            const onUpdateRelease = (release) => {
                ...
                if (release?.id) {
                    const index = data.editorReleases.findIndex(item => item.id === release.id);
                    if (index !== -1) {
                        data.editorReleases.splice(index, 1, release);
                    }
                }
            };

            const onEditOther = (payload) => {
                if (payload?.type !== 'tracks' || !payload?.release) {
                    return;
                }

                data.releaseEditorMode = false;
                data.selectedReleases = [payload.release];

                editReleaseTracks(data.selectedReleases[0]);
            };
      ...
      (data.item)
        ? (openBlock(), createElementBlock("div", _hoisted_2, [
            ...
            (data.section === 'collab-invites' && canEditContributorState.value)
              ...
              : createCommentVNode("", true),
            (data.section === 'settings' && canEditCuratorSettings.value)
              ? (openBlock(), createBlock(ArtistSettings, {
                  key: 6,
                  item: data.item,
                  onUpdate: onUpdate,
                  onEdit: onEdit
...
const Artists = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-29a7550c"]]);

export { Artists as default };
//# sourceMappingURL=Artists-C-fbDjJM.js.map
