import { _ as _export_sfc, a as useI18n, f as ref, j as onMounted, q as resolveComponent, b as createElementBlock, o as openBlock, h as createBaseVNode, c as createBlock, e as createCommentVNode, z as withKeys, n as normalizeClass, t as toDisplayString, I as IconButton, r as reactive, A as computed, B as withModifiers, C as normalizeStyle, x as createTextVNode, g as createVNode, u as unref, D as Button, G as message } from './index-DUMsV7Bg.js';
...
const Textarea = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-b7ec0f3e"]]);
...
const _sfc_main = {
  ...
  props: {
    ...
    sprite: { type: String, default: "actions" },
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        !props.dropZone ? (openBlock(), createBlock(IconButton, {
          ...
          onClick: selectFile
        }, null, 8, ["icon", "sprite", "loading"])) : (openBlock(), createElementBlock("div", {
          key: 1,
...
const FileUploader = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7825a6e0"]]);

export { FileUploader as F, Textarea as T };
//# sourceMappingURL=FileUploader-CiZLJtpv.js.map
