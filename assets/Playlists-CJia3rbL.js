import { s as stores, a as useI18n, r as reactive, b as createElementBlock, o as openBlock, g as createVNode, O as withCtx, h as createBaseVNode, J as Toggler, F as Fragment, i as api, j as onMounted, c as createBlock, e as createCommentVNode, u as unref, U as markRaw, _ as _export_sfc, f as ref, A as computed, m as watch, q as resolveComponent, w as withDirectives, v as vShow, n as normalizeClass, t as toDisplayString, V as _sfc_main$9, D as Button, K as Teleport, M as Loader, N as delay, G as message, d as renderList, Z as PlaylistPreview, E as EmptyLabel, $ as Playlists$2 } from './index-DjYaC0bW.js';
import { P as PageHeader } from './PageHeader-DheSd9iu.js';
import { _ as _sfc_main$7, d as _sfc_main$8, I as ItemsSections, e as _sfc_main$a, c as ItemsEditor, T as TrackEditor } from './TrackEditor-UZWjUnTf.js';
...
const PlaylistInfo = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-7ead1b33"]]);
...
const Playlists$1 = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-067fd15c"]]);
...
return (_ctx, _cache) => {
  return (openBlock(), createBlock(ItemsEditor, {
    ...
    code: data.code,
    canAdd: canAdd.value,
    getItem: _ctx.api.playlists().get,
...
const PlaylistEditor = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-86c84332"]]);
  ...
  setup(__props) {
    ...
    const closePlaylistEditorMode = () => {
        ...
        const onUpdatePlaylist = (playlist) => {
            ...
            if (playlist?.id) {
                const index = data.editorPlaylists.findIndex(item => item.id === playlist.id);
                if (index !== -1) {
                    data.editorPlaylists.splice(index, 1, playlist);
                }
            }
        };
...
const Playlists = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-13110a20"]]);

export { Playlists as default };
//# sourceMappingURL=Playlists-CJia3rbL.js.map
