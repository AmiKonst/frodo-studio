import { _ as _export_sfc, a as useI18n, r as reactive, b as createElementBlock, o as openBlock, g as createVNode, O as withCtx, h as createBaseVNode, k as Field, u as unref, a0 as DateField, a1 as maskEAN, F as Fragment, P as hooks, A as computed, d as renderList, c as createBlock, a2 as createSlots, x as createTextVNode, t as toDisplayString, D as Button, e as createCommentVNode, I as IconButton, y as _sfc_main$8, a3 as RELEASE_CONTRIBUTOR_ROLES, i as api, j as onMounted, U as markRaw, s as stores, f as ref, m as watch, q as resolveComponent, w as withDirectives, v as vShow, n as normalizeClass, V as _sfc_main$a, K as Teleport, M as Loader, N as delay, G as message, a4 as ReleasePreview, E as EmptyLabel } from './index-gcFB3s0p.js';
import { _ as _sfc_main$7, A as ArtistAutoComplete, f as IconState, d as _sfc_main$9, I as ItemsSections, e as _sfc_main$b, P as PageHeaderArtistTitle, c as ItemsEditor } from './TrackEditor-wRElY_sk.js';
...
const _sfc_main$6 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const onEANChange = (e) => {
        ...
        if (data.ean && data.ean.length < 12) {
    ...
    const onPreorderDateChange = (value) => {
        if (!value) {
            ...
            data.preorderDate = hooks(value).startOf('day').toISOString();
        }
...
const SectionReleaseInfo = /*#__PURE__*/_export_sfc(_sfc_main$6, [['__scopeId',"data-v-a885161d"]]);
...
const SectionContributors = /*#__PURE__*/_export_sfc(_sfc_main$5, [['__scopeId',"data-v-31728ec3"]]);
...
const _sfc_main$2 = {
  ...
  emits: ['update', 'add', 'remove', 'edit', 'sections', 'close', 'hide', 'actions', 'editOther'],
  setup(__props, { emit: __emit }) {
    ...
    // Permissions
        ...
        const canEditTracks = computed(() => {
            if (!data.item?.id) {
                return;
            }

            return releases.canEditTracks({
                release: data.item
            });
        });
          ...
          createBaseVNode("div", {
            ...
            (openBlock(), createBlock(Teleport, {
              ...
              (data.id)
                ...
                : createCommentVNode("", true),
              (data.id && canEditTracks.value && props.viewMode === 'list')
                ? (openBlock(), createBlock(Button, {
                    key: 4,
                    name: unref(t)(`pages.releases.edit-track.title`),
                    class: "size-s invert tertiary",
                    icon: "note",
                    sprite: "player",
                    disabled: data.uploading || hasChanges.value,
                    onClick: _cache[1] || (_cache[1] = $event => (emit('editOther', { type: 'tracks', release: data.item })))
...
const ReleaseInfo = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-9453b7eb"]]);
...
const Releases = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-383cc337"]]);
...
const _sfc_main = {
  ...
  emits: ['update', 'add', 'remove', 'close', 'editOther'],
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const canAdd = computed(() => {
        return releases.canAdd({ artist: props.artist });
    });
...
return (_ctx, _cache) => {
  return (openBlock(), createBlock(ItemsEditor, {
    ...
    onEditOther: _cache[4] || (_cache[4] = $event => (emit('editOther', $event))),
    ref_key: "editor",
    ref: editor
  }, {
    ...
    item: withCtx(({ toolbarId, item, viewMode, edit, add, update, remove, close, sections, hide, actions, editOther }) => [
      createVNode(ReleaseInfo, {
        ...
        onSections: sections,
        onActions: actions,
        onEditOther: editOther
      }, null, 8, ["toolbarId", "release", "viewMode", "artist", "onEdit", "onAdd", "onUpdate", "onRemove", "onClose", "onHide", "onSections", "onActions", "onEditOther"])
    ]),
    _: 1
...
const ReleaseEditor = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-496ec302"]]);

export { ReleaseEditor as R };
//# sourceMappingURL=ReleaseEditor-lI414_JX.js.map
