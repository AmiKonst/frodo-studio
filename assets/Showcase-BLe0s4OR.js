import { _ as _export_sfc, s as stores, a as useI18n, b as createElementBlock, e as createCommentVNode, o as openBlock, h as createBaseVNode, g as createVNode, t as toDisplayString, u as unref, ao as State, P as hooks, A as computed, i as api, c as createBlock, H as Img, f as ref, r as reactive, ap as code, j as onMounted, O as withCtx, l as renderSlot, X as mergeProps, Y as AutoComplete, m as watch, n as normalizeClass, D as Button, I as IconButton, aq as draggable, y as resolveComponent, V as _sfc_main$b, K as Teleport, E as EmptyLabel, F as Fragment, Z as PlaylistPreview, W as TrackPreview, a4 as ReleasePreview, ae as ArtistPreview, d as renderList, w as withDirectives, v as vShow, k as Field, a0 as DateField, J as Toggler, x as _sfc_main$c, M as Loader, N as delay, G as message } from './index-BSs3bC_m.js';
import { P as PageHeader } from './PageHeader-DBsyJFi2.js';
import { M as Menu } from './Menu-CQfTEcGj.js';
import { M as MultilingualField } from './MultilingualField-B0wfuZmt.js';
import { F as FileUploader } from './FileUploader-knMk9KYF.js';
  ...
  return (openBlock(), createElementBlock(Fragment, null, [
    (openBlock(), createBlock(Teleport, { to: "#head-buttons" }, [
      createVNode(_sfc_main$b, {
        ...
        trigger: withCtx(() => [
          createVNode(Button, {
            icon: "preview-list",
            name: unref(t)(`pages.showcase.lineup.sections.${data.viewMode}`),
        ...
        default: withCtx(() => [
          createBaseVNode("ul", null, [
            createBaseVNode("li", {
              onClick: _cache[0] || (_cache[0] = $event => (data.viewMode = 'all'))
            }, [
            ...
            createBaseVNode("li", {
              onClick: _cache[1] || (_cache[1] = $event => (data.viewMode = 'sections-only'))
            }, [
              createVNode(_component_Icon, { icon: "preview-list" }),
    ...
    createBaseVNode("div", _hoisted_1$6, [
      createVNode(unref(draggable), {
        modelValue: data.items,
        "onUpdate:modelValue": _cache[4] || (_cache[4] = $event => ((data.items) = $event)),
        "item-key": (item) => item.id,
        tag: "ul",
        handle: ".sort-button",
        "ghost-class": "dragging",
        group: "sections",
        onEnd: _cache[5] || (_cache[5] = () => {}),
        class: "items"
      }, {
        item: withCtx(({ element: item }) => [
          createBaseVNode("li", {
            ...
            createBaseVNode("div", {
              class: normalizeClass(["row", { preview: data.viewMode !== 'all' }])
            }, [
              createVNode(Button, {
                icon: "drag",
                class: "tertiary submenu size-m sort-button"
            ...
            (data.viewMode === 'all')
              ? (openBlock(), createBlock(ShowcaseLineupWidgets, {
                  ...
                  id: props.id,
                  sectionId: item.id,
                  onOpen: _cache[3] || (_cache[3] = $event => (emit('openWidget', $event)))
...
const ShowcaseLineup = /*#__PURE__*/_export_sfc(_sfc_main$6, [['__scopeId',"data-v-b65c0271"]]);
...
const ShowcaseLineupWidgetContent = /*#__PURE__*/_export_sfc(_sfc_main$5, [['__scopeId',"data-v-db34f4b8"]]);
...
const Showcase = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-7706b43c"]]);

export { Showcase as default };
//# sourceMappingURL=Showcase-BLe0s4OR.js.map
