import { _ as _export_sfc, s as stores, a as useI18n, b as createElementBlock, e as createCommentVNode, o as openBlock, h as createBaseVNode, g as createVNode, t as toDisplayString, u as unref, ao as State, P as hooks, A as computed, i as api, c as createBlock, H as Img, f as ref, r as reactive, ap as code, j as onMounted, O as withCtx, l as renderSlot, X as mergeProps, Y as AutoComplete, m as watch, n as normalizeClass, I as IconButton, B as withModifiers, D as Button, F as Fragment, aq as draggable, E as EmptyLabel, q as resolveComponent, V as _sfc_main$b, K as Teleport, Z as PlaylistPreview, W as TrackPreview, a4 as ReleasePreview, ae as ArtistPreview, d as renderList, w as withDirectives, v as vShow, k as Field, a0 as DateField, J as Toggler, y as _sfc_main$c, M as Loader, N as delay, G as message } from './index-DjYaC0bW.js';
import { P as PageHeader } from './PageHeader-DheSd9iu.js';
import { M as Menu } from './Menu-B-dCd2T3.js';
import { M as MultilingualField } from './MultilingualField-Bax2gXAs.js';
import { F as FileUploader } from './FileUploader-DH5PWHyI.js';
  ...
  return (props.item)
    ? (openBlock(), createElementBlock("div", _hoisted_1$a, [
        createBaseVNode("div", null, [
          createBaseVNode("span", null, toDisplayString(unref(locale).title(props.item?.name) || ''), 1),
          createVNode(State, {
...
const ShowcaseSectionPreview = /*#__PURE__*/_export_sfc(_sfc_main$a, [['__scopeId',"data-v-1bbaf99f"]]);
    ...
    ? (openBlock(), createElementBlock("span", _hoisted_1$9, [
        (props.item.cover?.resized || props.item.headerCover?.resized || defaultWidgetImage.value?.resized)
          ? (openBlock(), createBlock(Img, {
              ...
              alt: unref(locale).title(props.item?.name) || ''
        ...
        createBaseVNode("div", null, [
          ...
          (props.item.startDate || props.item.endDate)
            ? (openBlock(), createElementBlock("div", _hoisted_2$6, [
                (props.item.startDate || props.item.endDate)
                  ? (openBlock(), createElementBlock("span", _hoisted_3$5, toDisplayString(unref(hooks)(props.item.startDate).format('DD.MM')) + " - " + toDisplayString(unref(hooks)(props.item.endDate).format('DD.MM.YYYY')), 1))
                  : (props.item.startDate)
...
const ShowcaseWidgetPreview = /*#__PURE__*/_export_sfc(_sfc_main$9, [['__scopeId',"data-v-d445899c"]]);
...
const _sfc_main$8 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const onAutoCompleteSearch = async (value) => {
        ...
        const payload = await api.showcase().widget.list(params, data.code);
        ...
        data.optionList = await payload.items.filter(item => !item.sectionId).map(item => ({
            ...item,
            code: item.id,
        }));
    };
...
return (_ctx, _cache) => {
  return (openBlock(), createBlock(AutoComplete, mergeProps(props, {
    ...
    trigger: withCtx(() => [
      createBaseVNode("div", {
        class: "trigger-box",
        onClick: _cache[0] || (_cache[0] = $event => (onAutoCompleteSearch(data.name)))
      }, [
...
const ShowcaseWidgetAutoComplete = /*#__PURE__*/_export_sfc(_sfc_main$8, [['__scopeId',"data-v-329b3c8c"]]);
            ...
            (item.id)
              ? (openBlock(), createElementBlock("div", {
                  ...
                  createVNode(IconButton, {
                    icon: data.collapsed[item.id] ? 'chevron-down' : 'chevron-up',
                    class: "tertiary submenu size-m",
                    onClick: withModifiers($event => (data.collapsed[item.id] = !data.collapsed[item.id]), ["stop"])
                  }, null, 8, ["icon", "onClick"]),
                  createVNode(Button, {
                    icon: "drag",
                  ...
                  createVNode(IconButton, {
                    ...
                    onClick: withModifiers($event => (toggleShowed(item)), ["stop"])
                  }, null, 8, ["icon", "onClick"]),
                  createVNode(IconButton, {
                    icon: "close",
...
const ShowcaseLineupWidgets = /*#__PURE__*/_export_sfc(_sfc_main$7, [['__scopeId',"data-v-692683e9"]]);
    ...
    createVNode(unref(draggable), {
      ...
      item: withCtx(({ element: item }) => [
        createBaseVNode("li", {
          ...
          createBaseVNode("div", {
            class: normalizeClass(["row", { preview: props.viewMode !== 'all' }])
          }, [
            createVNode(IconButton, {
              icon: data.collapsed[item.id] ? 'chevron-down' : 'chevron-up',
              class: "tertiary submenu size-m",
              onClick: $event => (data.collapsed[item.id] = !data.collapsed[item.id])
            }, null, 8, ["icon", "onClick"]),
            createVNode(Button, {
              icon: "drag",
              class: "tertiary submenu size-m sort-button"
          ...
          (props.viewMode === 'all' && !data.collapsed[item.id])
            ? (openBlock(), createBlock(ShowcaseLineupWidgets, {
                key: 0,
                items: item.childs,
                id: props.id,
...
const ShowcaseLineup = /*#__PURE__*/_export_sfc(_sfc_main$6, [['__scopeId',"data-v-a64dd8d1"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    // Add
        ...
        const addPlaylist = async (payload, mode) => {
            ...
            const playlist = await api.showcase().widget.playlist.add({
                widgetId: props.item?.id,
        ...
        const addTrack = async (payload, mode) => {
            ...
            const track = await api.showcase().widget.track.add({
                widgetId: props.item?.id,
                trackId: payload?.id
            });
        ...
        const addRelease = async (payload, mode) => {
            ...
            const release = await api.showcase().widget.release.add({
                widgetId: props.item?.id,
        ...
        const addArtist = async (payload, mode) => {
            ...
            const artist = await api.showcase().widget.artist.add({
                widgetId: props.item?.id,
                artistId: payload?.id
            });
    ...
    onMounted(async () => {
        ...
        data.item = await api.showcase().widget.get(props.item.id);

        if (data.item?.releases?.length) {
            data.type = 'release';
            data.items = data.item.releases;
        }

        if (data.item?.tracks?.length) {
            data.type = 'track';
            data.items = data.item.tracks;
        }

        if (data.item?.playlists?.length) {
            data.type = 'playlist';
            data.items = data.item.playlists;
        }

        if (data.item?.artists?.length) {
            data.type = 'artist';
            data.items = data.item.artists;
        }
...
const ShowcaseLineupWidgetContent = /*#__PURE__*/_export_sfc(_sfc_main$5, [['__scopeId',"data-v-502bde45"]]);
...
const ShowcaseSections = /*#__PURE__*/_export_sfc(_sfc_main$4, [['__scopeId',"data-v-e715f6e1"]]);
...
const ShowcaseSectionInfo = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-9f5b167f"]]);
...
const ShowcaseWidgets = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-48ab2c34"]]);
...
const ShowcaseWidgetInfo = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-51e94ddd"]]);
          ...
          ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              (!data.item)
                ? (openBlock(), createBlock(_sfc_main$b, {
                    ...
                    invert: true,
                    size: "size-m",
                    onToggle: _cache[2] || (_cache[2] = $event => (data.addKebabActive = !data.addKebabActive))
                  }, {
                    trigger: withCtx(() => [
                      createVNode(Button, {
                        icon: "preview-list",
                        name: unref(t)(`pages.showcase.lineup.sections.${data.lineupViewMode}`),
                        class: normalizeClass({
                                active: data.addKebabActive,
                                'size-s': true
                            }),
                    ...
                    default: withCtx(() => [
                      createBaseVNode("ul", null, [
                        createBaseVNode("li", {
                          onClick: _cache[0] || (_cache[0] = $event => (data.lineupViewMode = 'all'))
                        }, [
                          createVNode(_component_Icon, { icon: "preview-list" }),
                          createBaseVNode("span", null, toDisplayString(unref(t)('pages.showcase.lineup.sections.all')), 1)
                        ]),
                        createBaseVNode("li", {
                          onClick: _cache[1] || (_cache[1] = $event => (data.lineupViewMode = 'sections-only'))
                        }, [
                          createVNode(_component_Icon, { icon: "preview-list" }),
                          createBaseVNode("span", null, toDisplayString(unref(t)('pages.showcase.lineup.sections.sections-only')), 1)
                        ])
                      ])
                    ]),
                    _: 1
...
const Showcase = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-1d383e75"]]);

export { Showcase as default };
//# sourceMappingURL=Showcase-CKovs6aa.js.map
