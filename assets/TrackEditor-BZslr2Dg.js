...
function getAutoStep(W, targetPx = 80) {
...
function drawGrid(W, H, reservedBottom = 0) {
...
function drawTimeline(W, H, bottomPadding = 8) {
    ...
    // const reserved = textHeight + bottomPadding;

    const pxPerMs = W / props.duration;
    // const textY = H - bottomPadding;
    ...
    for (let t = 0; t <= props.duration; t += step) {
        ...
        ctx.fillText(label, x, H - textHeight);
    }
...
const TrackWave = /*#__PURE__*/_export_sfc(_sfc_main$g, [['__scopeId',"data-v-3215d86e"]]);
...
const SectionTrackInfo = /*#__PURE__*/_export_sfc(_sfc_main$f, [['__scopeId',"data-v-9e374e86"]]);
...
//# sourceMappingURL=TrackEditor-BZslr2Dg.js.map
