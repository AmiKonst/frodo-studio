import { _ as _export_sfc, a as useI18n, A as computed, i as api, b as createElementBlock, e as createCommentVNode, o as openBlock, c as createBlock, h as createBaseVNode, H as Img, t as toDisplayString, u as unref, r as reactive, ap as code, j as onMounted, X as mergeProps, Y as AutoComplete, q as resolveComponent, ar as resolveDirective, w as withDirectives, s as stores, O as withCtx, F as Fragment, d as renderList, g as createVNode, D as Button, n as normalizeClass, V as _sfc_main$s, p as onBeforeUnmount, f as ref, C as normalizeStyle, x as createTextVNode, as as onUnmounted, I as IconButton, l as renderSlot, aq as draggable, E as EmptyLabel, at as resolveDynamicComponent, au as useSlots, m as watch, av as nextTick, B as withModifiers, aw as formatTime, k as Field, v as vShow, a2 as createSlots, y as _sfc_main$u, ak as TRACK_CONTRIBUTOR_ROLES, ax as TRACK_VERSIONS, ay as maskPreviewTime, J as Toggler, az as ALL_LANGUAGES_LIST, aA as maskISRC, aB as maskISWC, a0 as DateField, P as hooks, U as markRaw, K as Teleport, M as Loader, N as delay, G as message, W as TrackPreview } from './index-DQdMtHMi.js';
import { P as PageHeader } from './PageHeader-BBlMWFBY.js';
import { _ as _sfc_main$t } from './ViewMode-BmHAzNXY.js';
import { F as FileUploader, T as Textarea } from './FileUploader-BigCMdWm.js';
...
const PageHeaderArtistTitle = /*#__PURE__*/_export_sfc(_sfc_main$r, [['__scopeId',"data-v-304ecafe"]]);
...
const IconState = /*#__PURE__*/_export_sfc(_sfc_main$p, [['__scopeId',"data-v-f6e4a48a"]]);
...
const _hoisted_1$f = { class: "items-editor-header" };
    ...
    (openBlock(true), createElementBlock(Fragment, null, renderList(items.value, (item, id) => {
      return (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_3$7, [
          (item.name)
            ? (openBlock(), createElementBlock("label", _hoisted_4$5, [
...
const ItemsEditorHeader = /*#__PURE__*/_export_sfc(_sfc_main$n, [['__scopeId',"data-v-a3cc91fa"]]);
...
const _hoisted_1$e = { class: "items-editor" };
const _hoisted_2$8 = {
  key: 0,
  class: "item-detail"
};
...
const _sfc_main$l = {
  ...
  emits: ['update', 'add', 'remove', 'close', 'sort', 'editOther'],
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    // Edit Other
        const editOther = (payload) => {
            emit('editOther', payload);
        };
    ...
    const onClose = (payload) => {
        ...
        const doIt = async () => {
            ...
            const index = data.items.findIndex(item => (payload?.id && item.id === payload?.id) || (item.localId && item.localId === payload?.localId));
            ...
            if (payload?.id && data.item?.id === payload?.id || (data.item?.localId && data.item?.localId === payload?.localId)) {
                data.item = null;
            }
        };
            ...
            modals.confirm({
                ...
                onOk: async() => {
                    if (data.item) {
                        ...
                        const index = data.items.findIndex(item => (data.item?.id && item.id === data.item?.id) || (item.localId && item.localId === data.item?.localId));
...
const ItemsEditor = /*#__PURE__*/_export_sfc(_sfc_main$l, [['__scopeId',"data-v-57c6d909"]]);
...
const PageHeaderReleaseTitle = /*#__PURE__*/_export_sfc(_sfc_main$k, [['__scopeId',"data-v-f760f363"]]);
...
const PageHeaderPlaylistTitle = /*#__PURE__*/_export_sfc(_sfc_main$j, [['__scopeId',"data-v-8727dafd"]]);
...
const _sfc_main$i = {
  ...
  emits: ['change', 'error', 'sections', 'save', 'subscribe'],
  setup(__props, { emit: __emit }) {
      ...
      return (openBlock(), createElementBlock("div", {
        ...
        (item.name && props.viewMode === 'list')
          ? (openBlock(), createElementBlock("div", _hoisted_3$5, [
              createBaseVNode("label", _hoisted_4$4, toDisplayString(unref(t)(item.name)), 1)
            ]))
          : createCommentVNode("", true),
        createBaseVNode("div", {
          ...
          (openBlock(), createBlock(resolveDynamicComponent(item.component), {
            ...
            onSubscribe: _cache[3] || (_cache[3] = $event => (emit('subscribe', $event))),
...
const ItemsSections = /*#__PURE__*/_export_sfc(_sfc_main$i, [['__scopeId',"data-v-e1b8358a"]]);
    ...
    ? (openBlock(), createElementBlock("div", {
        ...
        renderSlot(_ctx.$slots, "title", {}, () => [
          (props.field?.name && props.viewMode === 'list')
            ? (openBlock(), createElementBlock("label", _hoisted_1$a, [
                createBaseVNode("span", null, toDisplayString(props.field.name), 1),
                (props.field.attention)
                  ? (openBlock(), createElementBlock("span", _hoisted_2$6, toDisplayString(props.field.attention), 1))
                  : createCommentVNode("", true)
              ]))
            : createCommentVNode("", true)
        ]),
...
const _hoisted_1$9 = { class: "track-wave-root" };
const _hoisted_2$5 = ["onPointerdown"];
const _hoisted_3$3 = ["title"];
const _hoisted_4$2 = ["onPointerdown"];
const _hoisted_5$1 = ["onPointerdown"];
const EDGE_TOLERANCE_PX = 24; // 20–32px нормально для mobile
...
const _sfc_main$g = {
  ...
  props: {
    ...
    timelineStep: { type: [Number, null], default: null }, // ms
    gridStep: { type: [Number, null], default: null }, // ms

    // Новое, надо добавить
    ranges: { type: [Array, null], default: null } // [{ limit: ms, value: { from, to }, editable: true }]
},
  emits: ['change', 'range'],
  setup(__props, { emit: __emit }) {
...
const getCssNumber = (varName, fallback = '0') => {
    if (!root.value) {
...
const getAutoStep = (W, targetPx = 80) => {
    if (!props.duration || props.duration <= 0) {
        return 0;
    }

    const approxCount = Math.max(1, Math.floor(W / targetPx));
    const rawStep = props.duration / approxCount;

    // нормализуем к "красивым" шагам: 1,2,5 * 10^n
...
const drawGrid = (W, H, reservedBottom = 0) => {
    if (!props.showGrid || !props.duration) {
        return;
    }

    const css = getComputedStyle(root.value);
    const strokeColor = css.getPropertyValue('--wave-grid-color') || 'rgba(0,0,0,0.08)';

    const step = props.gridStep > 0 ? props.gridStep : getAutoStep(W, 40);
    if (!step) {
        return;
    }
    ...
    const pxPerMs = W / props.duration;
    const bottomLimit = H - reservedBottom;
    ...
    for (let t = 0; t <= props.duration; t += step) {
        ...
        ctx.beginPath();
        ctx.moveTo(x + 0.5, 4);
        ctx.lineTo(x + 0.5, bottomLimit - 4);
        ctx.stroke();
    }
...
const drawTimeline = (W, H, bottomPadding = 8) => {
    if (!props.showTimeline || !props.duration) {
        return;
    }

    const css = getComputedStyle(root.value);
    const fillStyle = css.getPropertyValue('--wave-timeline-color') || 'rgba(0,0,0,0.6)';

    const step = props.timelineStep > 0 ? props.timelineStep : getAutoStep(W, 40);
    if (!step) {
        return;
    }
    ...
    (metrics.actualBoundingBoxAscent || 8) + (metrics.actualBoundingBoxDescent || 2);
    const pxPerMs = W / props.duration;
...
const draw = () => {
    ...
    // сначала вычисляем сколько места нужно под таймлайн
    ...
    if (props.showTimeline) {
        ...
        reservedBottom = textHeight + 8; // гарантированный отступ 8px
        ctx.restore();
    }

    drawGrid(W, H, reservedBottom);
    ...
    const usableHeight = H - reservedBottom;
    ...
    for (let i = 0; i < n; i++) {
        ...
        const barHeight = Math.max(1, frac * usableHeight);

        const drawIndex = locale.rtl ? (n - 1 - i) : i;
...
const clientXToMs = (clientX) => {
    ...
    if (x <= EDGE_TOLERANCE_PX) {
        return 0;
    }

    if (x >= W - EDGE_TOLERANCE_PX) {
...
let changeTimeout, rangeTimeout;

const kickPlayer = async (position) => {
    ...
    changeTimeout = setTimeout(async () => {
        ...
        const state = player.panes[props.pane]._state;

        if (state !== 'playing' && player.panes[props.pane]) {
            if (state === 'paused') {
                await player.panes[props.pane].resume();
            }
            if (state === 'stopped') {
                await player.panes[props.pane].play();
            }
        }
...
// RANGE
    const msToPx = (ms, width) => {
        if (!props.duration) return 0;
        return (ms / props.duration) * width;
    };

    const pxToMs = (px, width) => {
        if (!props.duration) return 0;
        return (px / width) * props.duration;
    };

    const rangesState = ref([]);
    ...
    watch(
        ...
        (val) => {
            nextTick(() => {
                ...
                rangesState.value = val.map(r => ({
                    ...r,
                    from: r.value?.from ?? 0,
                    to: r.value?.to ?? r.limitMin ?? 0
                }));
            });
        },
    ...
    // { type: 'left' | 'right' | 'move', index, startX, startFrom, startTo }

    const startDrag = (e, type, index) => {
        if (!rangesState.value[index].editable) return;
        ...
        activeDrag.value = {
            ...
            startFrom: rangesState.value[index].from,
            startTo: rangesState.value[index].to
        };
    ...
    const onDrag = (e) => {
        ...
        const range = rangesState.value[d.index];

        const dx = e.clientX - d.startX;
        const deltaMs = pxToMs(dx, d.rectWidth);

        const duration = props.duration;
        const limitMax = range.limitMax ?? duration;
        const limitMin = range.limitMin ?? 0;

        let newFrom = d.startFrom;
        let newTo = d.startTo;

        if (d.type === 'left') {
            newFrom = d.startFrom + deltaMs;

            // нельзя правее правого ушка - limitMin
            newFrom = Math.min(newFrom, d.startTo - limitMin);

            // нельзя левее 0
            newFrom = Math.max(0, newFrom);

            // превышение limitMax
            if (d.startTo - newFrom > limitMax) {
                newTo = newFrom + limitMax;
            }
        }

        if (d.type === 'right') {
            newTo = d.startTo + deltaMs;

            // нельзя левее left + limitMin
            newTo = Math.max(newTo, d.startFrom + limitMin);

            // нельзя правее duration
            newTo = Math.min(duration, newTo);

            // превышение limitMax
            if (newTo - d.startFrom > limitMax) {
                newFrom = newTo - limitMax;
            }
        }

        if (d.type === 'move') {
            const width = d.startTo - d.startFrom;
            ...
            if (newTo > duration) {
                newTo = duration;
                newFrom = duration - width;
            }
        }

        range.from = clamp(newFrom, 0, duration);
        range.to = clamp(newTo, 0, duration);

        range.changed = true;

        clearTimeout(rangeTimeout);
        rangeTimeout = setTimeout(async () => {
            emit('range', {
            ...
            onChange(Math.round(range.from));
        }, 100);
    };

    const stopDrag = () => {
        const index = activeDrag.value.index;
        const range = rangesState.value[index];
        activeDrag.value = null;
        window.removeEventListener('pointermove', onDrag);
        window.removeEventListener('pointerup', stopDrag);

        if (!range.changed) {
            kickPlayer(range.from);
        }
    };
    ...
    const rangeStyle = (r) => {
        ...
        const left = msToPx(r.from, width);
        const w = msToPx(r.to - r.from, width);
...
watch(
    () => [
        ...
        props.showGrid, props.showTimeline, props.timelineStep, props.gridStep
    ],
    () => {
...
return (_ctx, _cache) => {
  return (openBlock(), createElementBlock("div", _hoisted_1$9, [
    ...
    (rangesState.value.length)
      ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: "ranges-box",
          style: normalizeStyle({ height: rangesState.value.length * RANGE_HEIGHT + 'px' })
        }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(rangesState.value, (item, i) => {
            return (openBlock(), createElementBlock("div", {
              class: normalizeClass(["range", { disabled: !item.editable }]),
              key: item.code,
              style: normalizeStyle({
                    top: i * RANGE_HEIGHT + 'px'
                })
            }, [
              createBaseVNode("div", {
                class: "range-body",
                style: normalizeStyle(rangeStyle(item)),
                onPointerdown: withModifiers($event => (startDrag($event, 'move', i)), ["stop"])
              }, [
                (item.name)
                  ? (openBlock(), createElementBlock("label", {
                      ...
                      class: "title",
                      title: item.name
                    }, toDisplayString(item.name), 9, _hoisted_3$3))
                  : createCommentVNode("", true),
                createBaseVNode("span", {
                  class: "handle left",
                  onPointerdown: withModifiers($event => (startDrag($event, 'left', i)), ["stop"])
                }, null, 40, _hoisted_4$2),
                createBaseVNode("span", {
                  class: "handle right",
                  onPointerdown: withModifiers($event => (startDrag($event, 'right', i)), ["stop"])
...
const TrackWave = /*#__PURE__*/_export_sfc(_sfc_main$g, [['__scopeId',"data-v-1df5f42c"]]);
...
const _sfc_main$f = {
  ...
  emits: ['change', 'error', 'metadata', 'subscribe', 'save'],
  setup(__props, { emit: __emit }) {
    ...
    emit('subscribe', {
        fields: ['snippetStartTime', 'snippetEndTime'],
        section: 'track-info',
        callback: (payload) => {
            if ([null, undefined].includes(payload.value) || payload.value < 0 || payload.value > props.item.duration) {
                return
            }

            if (payload?.field === 'snippetStartTime') {
                if (data.snippetStartTime !== payload.value) {
                    data.snippetStartTime = payload.value;
                }
            }

            if (payload?.field === 'snippetEndTime') {
                if (data.snippetEndTime !== payload.value) {
                    data.snippetEndTime = payload.value;
                }
            }
        }
    });
    ...
    const data = reactive({
        ...
        snippetStartTime: props.item.snippetEndTime ? props.item.snippetStartTime || 0 : 0,
        snippetEndTime: props.item.snippetEndTime || 30_000
    });
    ...
    const onSnippetChange = (e) => {
        if (!e?.from && !e?.to) {
            return;
        }

        const from = parseInt(e.from / 1000) * 1000;
        const to = parseInt(e.to / 1000) * 1000;

        data.snippetStartTime = from;
        data.snippetEndTime = to;

        emit('change', {
            snippetStartTime: from,
            snippetEndTime: to
        });
    };
    ...
    withDirectives(createVNode(_sfc_main$h, {
      ...
      default: withCtx(() => [
        createBaseVNode("div", {
          ...
          (!data.loading && props.item?.wave)
            ? (openBlock(), createBlock(TrackWave, {
                key: 0,
                wave: props.item.wave,
                id: props.item.id,
                duration: props.item.duration,
                simplify: props.viewMode === 'table' ? 3 : 1,
                showTimeline: true,
                showGrid: true,
                ranges: [{
                    name: unref(t)('pages.tracks.sections.snippet.name'),
                    code: 'snippet',
                    editable: props.permissions.canEdit,
                    limitMax: 30_000,
                    limitMin: 15_000,
                    value: {
                        from: data.snippetStartTime,
                        to: data.snippetEndTime
                    }
                }],
                onRange: onSnippetChange
              }, null, 8, ["wave", "id", "duration", "simplify", "ranges"]))
            : createCommentVNode("", true),
          createVNode(FileUploader, {
            class: "upload",
            acceptedFormats: ['.wav', 'audio/wav', 'audio/x-wav'],
            dropZone: !props.item?.wave || data.loading,
            disabled: !props.permissions.canEdit,
...
const SectionTrackInfo = /*#__PURE__*/_export_sfc(_sfc_main$f, [['__scopeId',"data-v-8629ffc9"]]);
...
const ArtistAutoComplete = /*#__PURE__*/_export_sfc(_sfc_main$e, [['__scopeId',"data-v-628d2c86"]]);
...
const SectionContributors = /*#__PURE__*/_export_sfc(_sfc_main$d, [['__scopeId',"data-v-04d546ca"]]);
...
const SectionRating = /*#__PURE__*/_export_sfc(_sfc_main$9, [['__scopeId',"data-v-6139bf73"]]);
...
const _sfc_main$8 = {
  ...
  setup(__props, { emit: __emit }) {
        ...
        callback: (payload) => {
            ...
            if (payload?.field === 'snippetStartTime') {
                if (data.snippetStartTime !== payload.value) {
                    ...
                    from.value.data.maskInstance.typedValue = prepare(data.snippetStartTime);
                }
            }
            ...
            if (payload?.field === 'snippetEndTime') {
                if (data.snippetEndTime !== payload.value) {
                    data.snippetEndTime = payload.value;
                    to.value.data.maskInstance.typedValue = prepare(data.snippetEndTime);
                }
            }
        }
    });
    ...
    const onSnippetStartTimeChange = (e) => {
        ...
        const value = ((e.target.typedValue.min || 0) * 60 + (e.target.typedValue.sek || 0)) * 1000;

        if (data.snippetStartTime === value) {
            return;
        }

        data.snippetStartTime = value;
    ...
    const onSnippetEndTimeChange = (e) => {
        ...
        if (data.snippetEndTime === value) {
            return;
        }

        data.snippetEndTime = value;
  ...
  setup(__props, { emit: __emit }) {
    ...
    const onReleaseDateChange = (value) => {
        if (!value) {
            ...
            data.releaseDate = hooks(value).startOf('day').toISOString();
        }
...
const _sfc_main$3 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    if (props.permissions.canEditRating) {
        sections.push({
            id: 'rating',
...
return (_ctx, _cache) => {
  return (openBlock(), createBlock(ItemsSections, {
    ...
    onSubscribe: _cache[4] || (_cache[4] = $event => (emit('subscribe', $event)))
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const onSectionSubscribe = (payload) => {
        if (!payload?.section) {
            return;
        }

        data.subscribes = data.subscribes.filter(item => item.section !== payload.section);
        data.subscribes.push(payload);
    };
    ...
    const onSectionChange = (payload) => {
        ...
        Object.keys(payload).forEach(field => {
            data.updatedItem[field] = payload[field];

            data.subscribes.forEach(item => {
                if (item.fields?.includes(field) && item.callback) {
                    item.callback({ field, value: payload[field] });
                }
            });
        });
    ...
    const checkTracksLimit = async (artistId) => {
        let params = {
            skip: 0,
            take: 1,
        ...
        const maxCount = await api.entity().artist.curator(artistId, 'MAX_TRACK_CREATE_COUNT');

        if (!maxCount || payload?.total >= maxCount) {
            modals.open('reject', {
                data: {
                    timer: 6,
                    title: t(`pages.tracks.limit.title`),
                    description: `${
                        t(`pages.tracks.limit.current-plan`, { n: maxCount })
                    } ${t(`pages.tracks.limit.upgrade`)}`,
                    close: t(`pages.tracks.add.done.close`)
                },
                quietClose: true
            });
            return false;
    ...
    const saveChanges = async (mode) => {
        ...
        if (!data.id) {
            ...
            if (!await checkTracksLimit(trackInfo.artist)) {
                data.updating = false;
                return;
            }
        }
    ...
    (!data.loading)
      ? withDirectives((openBlock(), createElementBlock("div", {
          ...
          createVNode(_sfc_main$3, {
            ...
            onSubscribe: onSectionSubscribe,
...
const TrackInfo = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-d10feb88"]]);
...
const Tracks = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-8fed0a6c"]]);
        ...
        modals.open('select-tracks', {
            ...
            callback: async (items) => {
                ...
                const doIt = async () => {
                    ...
                    item.position = offset + 1;
                    offset += 1;

                    // Добавляем к релизу
                    await addItemToRelease(item, item.position);

                    // Добавляем к плейлисту
                    await addItemToPlaylist(item, item.position);
...
const TrackEditor = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-829e5c11"]]);
...
//# sourceMappingURL=TrackEditor-CKw0oIKF.js.map
