...
const indexToMs = (index) => {
    const n = nBars.value;
    if (!props.duration || n <= 0) {
        return 0;
    }
...
const TrackWave = /*#__PURE__*/_export_sfc(_sfc_main$g, [['__scopeId',"data-v-0add9177"]]);
    ...
    emit('subscribe', {
        ...
        callback: (payload) => {
            ...
            if (payload?.field === 'snippetEndTime') {
                if (data.snippetEndTime !== payload.value) {
                    data.snippetEndTime = payload.value;
                    to.value.data.maskInstance.typedValue = prepare(data.snippetStartTime);
                }
            }
        }
    });
...
const TrackInfo = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-107e0737"]]);
...
//# sourceMappingURL=TrackEditor-DCkS-2bX.js.map
